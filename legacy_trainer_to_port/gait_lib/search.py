...
Stage 4:
    python legacy_trainer_to_port/gait_lib/search.py --run legacy_trainer_to_port/runs/v2_lib_s2_free_s0 --entry 3 --evals 400
...
Stage 5:
    python legacy_trainer_to_port/gait_lib/search.py --run ... --absorb --entry 3
