...
PRESETS = {
    ...
    #   python legacy_trainer_to_port/train.py --preset v3_stage2 --name v3_stage2_s0 --seed 0     #          --warm-start legacy_trainer_to_port/runs/v3_stage1_s0/final.msgpack ...
    #   python legacy_trainer_to_port/train.py --preset v3       --name v3_s0       --seed 0     #          --warm-start legacy_trainer_to_port/runs/v3_stage2_s0/final.msgpack ...
    #
    ...
    # needed. Read legacy_trainer_to_port/README.md "Known limits" before spending GPU hours here.
    #
