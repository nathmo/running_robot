...
This runs the SHIPPING control law -- `controller/deploy/controller_v2.PolicyControllerV2`, the torch-free
...
def main():
    ...
    ap.add_argument("--bundle", required=True,
                    help="an .npz written by legacy_trainer_to_port/export.py")
