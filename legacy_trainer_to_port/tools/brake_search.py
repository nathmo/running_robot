...
falls while ACCELERATING (see the table in legacy_trainer_to_port/README.md). Two explanations remain, and they call for
opposite fixes:
...
a stop and (a) holds. If thousands cannot, (b) holds.
    ...
    python legacy_trainer_to_port/tools/brake_search.py --run legacy_trainer_to_port/runs/<run> --checkpoint <ckpt.msgpack>
