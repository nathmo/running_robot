...
trajectory drifts from the XML's own settings over --check-ticks ticks.
    ...
    python legacy_trainer_to_port/tools/profile_step.py --n-envs 8 --variants xml newton8 cg6
    python legacy_trainer_to_port/tools/profile_step.py --n-envs 256 2048 4096 --json legacy_trainer_to_port/results/profile_step.json
"""
