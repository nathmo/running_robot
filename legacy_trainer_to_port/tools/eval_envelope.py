"""The §08 margin budget as a batched gate: one greedy policy, every axis, pass/fail per row.
    ...
    python legacy_trainer_to_port/tools/eval_envelope.py --run legacy_trainer_to_port/runs/v2_s2_free_s0 [--json out.json]
    python legacy_trainer_to_port/tools/eval_envelope.py --run ... --axes push_lat wind_x delay
