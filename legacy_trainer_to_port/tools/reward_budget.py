...
staying alive pays.
    ...
    python legacy_trainer_to_port/tools/reward_budget.py --run legacy_trainer_to_port/runs/<run> --preset v3_joystick_s2
    python legacy_trainer_to_port/tools/reward_budget.py --cold --preset v4_runstop_stage1 --sample
...
def main():
    ...
    if args.cold:
        ...
        # the base spring is ON at the start of every cold run (initial_params: base_spring 1.0),
    ...
    print(f"[budget] env params: bringup_scale={params.bringup_scale:.2f} spring={params.base_spring:.2f} "
