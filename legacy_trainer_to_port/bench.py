"""Throughput benchmark: env steps/s of the MJX plant vs batch size, and the whole PPO iteration.
    ...
    python legacy_trainer_to_port/bench.py                       # sweep n_envs 256..8192 on the local device
    python legacy_trainer_to_port/bench.py --n-envs 4096 --ppo   # + one full PPO iteration at that size
    python legacy_trainer_to_port/bench.py --json results/bench_lyra_rtx6000.json
