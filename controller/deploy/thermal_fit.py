...
"""DESKTOP TOOL. Fit the two-node thermal model to blocked-rotor calibration logs.
    ...
    python controller/deploy/thermal_fit.py --self-test
    ...
    python controller/deploy/thermal_fit.py --logs data/thermal/thermal_left_thigh_*.npz \\
...
def main():
    ...
    if not files:
        raise SystemExit("no logs matched. Run controller/deploy/thermal_calibrate.py on the robot "
