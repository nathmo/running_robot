...
"""ROBOT TOOL. Run a trained policy on DASH-01 in force-control mode, under the safety governor.
    ...
    python controller/deploy/run_policy.py --bundle .../imp_m2_long_204M.npz --mock --max-seconds 5
    ...
    python controller/deploy/run_policy.py --bundle .../v2c_s2_free_dp2x_stop_s0.npz \\
    ...
    python controller/deploy/run_policy.py --bundle .../v3_joy_s0.npz \\
        --jointmap controller/deploy/deploy_map.json --command-file /tmp/dash_command --max-seconds 30
