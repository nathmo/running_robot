"""Build deploy_map.json — the normalized-degrees -> model-radians map run_policy.py requires.
    ...
    python controller/deploy/make_deploy_map.py --model-map controller/fixed_gait/webui/data/model_map.json \
        --out controller/deploy/deploy_map.json
...
def main():
    ...
    ap.add_argument("--model-map", default="controller/fixed_gait/webui/data/model_map.json")
    ap.add_argument("--out", default="controller/deploy/deploy_map.json")
