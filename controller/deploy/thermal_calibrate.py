...
"""ROBOT TOOL. Excite ONE motor with a known current schedule and log its temperature response.
    ...
    python controller/deploy/thermal_calibrate.py --motor left.thigh --mock --steps 6:20,0:60

    # on the robot, with the webui daemon STOPPED
    sudo systemctl stop runningrobot-webui.service
    python controller/deploy/thermal_calibrate.py --motor left.thigh --steps 6:180,0:900 \\
        --joint-is-blocked
