...
plain JSON side-file rather than the daemon. It is:
  ...
  * consumed by the offline estimator (controller/identification/): masses fix each body's total mass,
...
# controller/model/dash01.xml, whose total is 12.83 kg against a real 15.14 kg (+18%).
#
