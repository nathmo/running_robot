...
```
python controller/fixed_gait/webui/server.py          # real robot (socketcan can0/can1)
python controller/fixed_gait/webui/server.py --mock   # simulated motors — try the UI on any machine
python controller/fixed_gait/webui/server.py --port 8080 --host 0.0.0.0
```
...
```
python controller/fixed_gait/webui/sensehat.py          # CLI self-test: one live line per second
python controller/fixed_gait/webui/sensehat.py --mock   # synthetic values, no hardware
python controller/fixed_gait/webui/server.py --no-sensors   # do not touch I2C at all
```
...
```
python controller/fixed_gait/webui/blackbox_read.py --postmortem      # the five questions, answered
python controller/fixed_gait/webui/blackbox_read.py --list
python controller/fixed_gait/webui/blackbox_read.py --timeline 80
python controller/fixed_gait/webui/blackbox_read.py --dump B_xxx.bbdump --csv out.csv
```
...
```
python -m pytest controller/fixed_gait/webui/tests -v
```
...
python controller/fixed_gait/webui/server.py
```
...
```
sudo cp controller/fixed_gait/webui/systemd/runningrobot-webui.service /etc/systemd/system/
```
