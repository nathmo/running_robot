...
# REPO is added so the offline identification package (controller/identification/) is importable from
...
# controller/deploy/ holds the pure, hardware-free control and thermal modules (thermal_excite,
...
# STL meshes for the 3D limb viewer (controller/model/dash01.xml points its meshdir at the CAD export).
_MESH_CANDIDATES = [
...
# export_policy.py writes to controller/deploy/bundles/ (it is part of the deploy package and knows
