...
mp4 rendered with classic MuJoCo from the recorded qpos trajectory.
    ...
    python walk_v4/evaluate.py --run walk_v4/runs/v2_s1_planar_s0 --episodes 16
    python walk_v4/evaluate.py --run walk_v4/runs/v2_s1_planar_s0 --video dash.mp4 --seconds 40
    python walk_v4/evaluate.py --run ... --dr            # with the training randomization on
