...
training configurations could not answer (walk_v4/README.md). Before spending another training
...
parameters, so the CEM converges fast.
    ...
    python walk_v4/tools/speed_lib.py --run ... --checkpoint ... --targets 1.0,1.5,2.0,2.5,3.0
