...
node: x_{k+1} = x_k + (dt/tau_th)(tau_rms^2/(tau_cont^2 s) - x_k).
    ...
    python walk_v4/tools/limits_check.py --run walk_v4/runs/v2c_s2_free_dp2x_s0
    python walk_v4/tools/limits_check.py --run ... --checkpoint ...best_88473600.msgpack --dr
    python walk_v4/tools/limits_check.py --run ... --episodes 8 --seconds 45 --json out.json
"""
import argparse
import json
import sys
