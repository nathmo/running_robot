"""Cross-implementation trace: the numbers two implementations of the v2 design must agree on.
    ...
    python walk_v4/tools/trace.py --out walk_v4/results/trace_mjx.json [--preset v2_s2_free] [--ticks 300]
    python walk_v4/tools/trace.py --rig --out walk_v4/results/trace_mjx_rig.json      # welded in the air
    python walk_v4/tools/compare_traces.py walk_v4/results/trace_mjx.json <other_impl_trace.json>
...
trace's state via walk_v4/gait.py in numpy) and the trajectory divergence time.
"""
import argparse
import json
import sys
