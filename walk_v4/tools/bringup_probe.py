...
distribution, and so is the release transient (the legs take the full weight in one tick).
    ...
    python walk_v4/tools/bringup_probe.py --run walk_v4/runs/v2c_s2_free_dp2x_s0 --sweep basic
    python walk_v4/tools/bringup_probe.py --run ... --hold 3.0 --pitch 10 --video drop.mp4
