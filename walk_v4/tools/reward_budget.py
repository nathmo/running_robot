...
staying alive pays.
    ...
    python walk_v4/tools/reward_budget.py --run walk_v4/runs/<run> --preset v3_joystick_s2
    python walk_v4/tools/reward_budget.py --cold --preset v4_runstop_stage1 --sample
