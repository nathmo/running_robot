"""Throughput benchmark: env steps/s of the MJX plant vs batch size, and the whole PPO iteration.
    ...
    python RLframework/bench.py                       # sweep n_envs 256..8192 on the local device
    python RLframework/bench.py --n-envs 4096 --ppo   # + one full PPO iteration at that size
    python RLframework/bench.py --json results/bench_lyra_rtx6000.json
