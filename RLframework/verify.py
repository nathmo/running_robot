"""Does this policy meet the contract? One command, one PASS/FAIL table, no interpretation needed.
    ...
    python RLframework/verify.py --run RLframework/runs/v3_s0
    python RLframework/verify.py --run RLframework/runs/v3_s0 --checkpoint RLframework/runs/v3_s0/best.msgpack
