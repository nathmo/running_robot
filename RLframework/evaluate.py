...
mp4 rendered with classic MuJoCo from the recorded qpos trajectory.
    ...
    python RLframework/evaluate.py --run RLframework/runs/dash_s0 --episodes 16
    python RLframework/evaluate.py --run RLframework/runs/dash_s0 --video dash.mp4 --seconds 40
    python RLframework/evaluate.py --run ... --dr            # with the training randomization on
