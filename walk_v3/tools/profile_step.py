...
trajectory drifts from the XML's own settings over --check-ticks ticks.
    ...
    python walk_v3/tools/profile_step.py --n-envs 8 --variants xml newton8 cg6
    python walk_v3/tools/profile_step.py --n-envs 256 2048 4096 --json walk_v3/results/profile_step.json
"""
