"""The §08 margin budget as a batched gate: one greedy policy, every axis, pass/fail per row.
    ...
    python walk_v3/tools/eval_envelope.py --run walk_v3/runs/v2_s2_free_s0 [--json out.json]
    python walk_v3/tools/eval_envelope.py --run ... --axes push_lat wind_x delay
