...
falls while ACCELERATING (see the table in walk_v3/README.md). Two explanations remain, and they call for
opposite fixes:
...
a stop and (a) holds. If thousands cannot, (b) holds.
    ...
    python walk_v3/tools/brake_search.py --run walk_v3/runs/<run> --checkpoint <ckpt.msgpack>
