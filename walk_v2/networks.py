...
class ObsMirror:
    ...
    L<->R negated, gravity y and gyro x/z negated, LP yaw negated, the phase shifted to
    phi - pi - Delta with Delta read from the once-block), the once-block's five knobs and
    reflex bias negated. Built once from the env's layout."""
